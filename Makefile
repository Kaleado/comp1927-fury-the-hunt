...
OBJS = GameView.o Map.o Places.o Map.o Queue.o PlayerRep.o
...
hunter : hunterPlayer.o hunter.o HunterView.o hunterAi.o $(OBJS) $(LIBS)
...
hunterAi.o : hunterAi.c Globals.h Map.h hunterAi.h
