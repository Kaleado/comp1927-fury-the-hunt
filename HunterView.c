                        ...
                        int road, int rail, int sea)
{
   ...
   LocationID *adjacent = connectedLocations(currentView->game, numLocations, getLocation(currentView->game,currPlayer), currPlayer, getRound(currentView->game),road,rail,sea);
   ...
   {
      locations[locationIndex] = adjacent[i];       locationIndex++;
   }
